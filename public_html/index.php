			...
			<div class="preload"><div></div></div>
				<div id="lof-main-outer">
					<ul class="lof-main-wapper">
						<li><img src="img/slide/bannerlaptopthang12_800x450-600x400.png" width="1000" height="350"></li>
						<li><img src="img/slide/thietkehaithanh-banner-laptop-800x300.png" width="1000" height="350"></li>
						<li><img src="img/slide/5993697eddda5ac69cd78b62d3bd85e7.png" width="1000" height="350"></li>
						<li><img src="img/slide/PR_40595-1.jpg" width="1000" height="350"></li>
					...
					<div onClick="return false" href="" class="lof-next">Next</div>
					  <div class="lof-navigator-outer">
							<ul class="lof-navigator">
							   <li><img src="img/slide/bannerlaptopthang12_800x450-600x400.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/thietkehaithanh-banner-laptop-800x300.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/5993697eddda5ac69cd78b62d3bd85e7.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/PR_40595-1.jpg" width="70" height="25" /></li>       		
	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Phạm Thị Thùy</span></li> <br>
						
						<li>Địa chỉ: Hòa Khánh - Đà Nẵng </li>
						<li>Điện thoại: 0123456789 - Hotline:  012345678</li>
						<li>Email:  phamthithuy@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
				...
				<div id="copyright">
					<p>Sinh Viên : Phạm Thị Thùy | Lớp : 18CNTT03 | Gmail : thuy@gmail.com<p>
				</div><!-- End .copyright -->
